...
function BasinBulteniPaketleri() {
  return (
    <>
      {/* 2. Hero */}
      <header className="border-b-2 border-ink px-6 py-24 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-block bg-accent text-white px-3 py-1 text-sm font-bold uppercase tracking-widest mb-8">
            Şeffaf Fiyatlandırma
          </div>
          <h1 className="font-display text-[clamp(4rem,8vw,8rem)] leading-none uppercase tracking-tighter mb-10">
